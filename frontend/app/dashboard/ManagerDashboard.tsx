  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
      ...
      <div className="col-span-2 lg:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6 flex flex-col transition-transform transform hover:scale-105">
          <h2 className="text-lg font-bold mb-4 text-gray-800">
      ...
      <div className="col-span-2 lg:col-span-3 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-6">
